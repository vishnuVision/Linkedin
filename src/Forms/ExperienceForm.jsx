                ...
                !image && !imagePreview && <form onSubmit={handleSubmit}>
                    <div className='max-h-[60vh] overflow-y-scroll'>
                        <div className='flex flex-col gap-4 px-2'>
                            ...
                            <Select label={"Employment type"} list={["Please select", "Full-time", "Part-time", "Self-employed", "Freelance", "Internship", "Trainee"]} />
                            ...
                            <Select label={"Location"} list={["Please select", "Surat", "India"]} />

                            <Select label={"Location type"} list={["Please select", "On-site", "Hybrid", "Remote"]} />

                            <div className="flex gap-2">
                                <input className="w-6 h-6" name="im" type="checkbox" />
